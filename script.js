...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (contactForm) {
        ...
        contactForm.addEventListener('input', function(e) {
            ...
            if (input && (input.classList.contains(errorClass) || input.classList.contains(successClass))) {
                validateField(input);
            }
        });
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '6ce85537-b8a9-4681-8ef7-a0ffe8e39efb',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '6ce85537-b8a9-4681-8ef7-a0ffe8e39efb';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '6ce85537-b8a9-4681-8ef7-a0ffe8e39efb';
